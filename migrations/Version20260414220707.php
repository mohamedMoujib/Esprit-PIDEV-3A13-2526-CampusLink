 ...
 */
final class Version20260414220707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices CHANGE issue_date issue_date DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE details details LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE messages ADD is_read TINYINT NOT NULL, CHANGE content content LONGTEXT NOT NULL, CHANGE timestamp timestamp DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoices CHANGE issue_date issue_date DATETIME DEFAULT \'current_timestamp()\', CHANGE details details TEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE messages DROP is_read, CHANGE content content TEXT NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp()\'');
