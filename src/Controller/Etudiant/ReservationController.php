...
class ReservationController extends AbstractController
{
    ...
    public function index(
        ...
        // Add coordination info for each reservation
        $coordinationStatus = [];
        foreach ($reservations as $reservation) {
            // A reservation is coordinated only if it already has a payment
            $isCoordinated = !$reservation->getPayments()->isEmpty();
            $coordinationStatus[$reservation->getId()] = $isCoordinated;
        }
